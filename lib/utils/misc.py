...
class NestedTensor(object):
    def __init__(self, tensors, mask: Optional[Tensor], mask_box = None):
    ...
    def to(self, device):
        ...
        if mask_box is not None:
            ...
            cast_mask_box = mask_box.to(device)
        else:
            cast_mask_box = None
        return NestedTensor(cast_tensor, cast_mask, cast_mask_box)

    def decompose(self):
        if self.mask_box is not None:
            return self.tensors, self.mask, self.mask_box
        else:
