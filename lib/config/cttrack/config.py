...
cfg.MODEL.BACKBONE.USE_CLS_TOKEN = False
...
cfg.MODEL.BOXHEAD.FREEZE_BN = False

# MODEL.SCOREHEAD
cfg.MODEL.SCOREHEAD = edict()
cfg.MODEL.SCOREHEAD.EXIST = False
...
cfg.TRAIN.RENEW_WEIGHT = 1.0

# TRAIN.RENEW
cfg.TRAIN.RENEW = edict()
cfg.TRAIN.RENEW.TEMPLATE_TO_TEMPLATE = False
cfg.TRAIN.RENEW.TEMPLATE_TO_SEARCH = False
cfg.TRAIN.RENEW.SEARCH_TO_TEMPLATE = False
cfg.TRAIN.RENEW.SEARCH_TO_SEARCH = False
...
cfg.TEST.UPDATE_INTERVALS.UAV = [45]
