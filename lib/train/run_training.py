...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 use_lmdb=False, script_name_prv=None, config_name_prv=None, load_epoch=None):
    ...
    if "cls" in script_name:
        settings.script_name_prv = script_name_prv = script_name[:-4]
        settings.config_name_prv = config_name_prv = config_name
        settings.load_epoch = load_epoch
...
def main():
    ...
    parser.add_argument('--seed', type=int, default=8823+1, help='seed for random numbers')
    ...
    parser.add_argument('--load_epoch', type=int, default=100, help="Epoch of previous model.")
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 use_lmdb=args.use_lmdb, script_name_prv=args.script_prv, config_name_prv=args.config_prv, load_epoch=args.load_epoch)
